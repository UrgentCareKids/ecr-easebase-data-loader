...
tables = ['mat_tmp_fast_demographics', 'mat_fast_search_json', 'mahler_event_cx', 'mahler_id_cx', 'mstr_hl7_interface_id_cx', 'mstr_guarantor_hl7_interface_id_cx', 'mstr_intake_transaction_router']
