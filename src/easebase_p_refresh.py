...
channel = 'easebase'
procs = ['p_pond_visit_order()', 'p_patient_ptsrv()', 'p_patient_mahler()', 'p_invoice_summary()', 'p_invoice_line()', 'p_pond_location()', 'p_pond_organization()', 'tmp_mahler_visits_w_closed_charts()']
